...
class UUPopView: UIView {
    ...
    func show(text: String, width: CGFloat? = kScreenWidth, sender: UIView? = nil) {
    ...
    func setupView() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(UUPopView.hide))
